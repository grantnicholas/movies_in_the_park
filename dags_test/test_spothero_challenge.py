...
def test_parse_darkspy_api_response():
    # returned from requests.get().json()
    sample_response = {"latitude": 41.857935, "longitude": -87.622279, "timezone": "America/Chicago",
                       "currently": {"time": 1532869200, "summary": "Mostly Cloudy", "icon": "partly-cloudy-day",
                                     "precipIntensity": 0, "precipProbability": 0, "temperature": 68.62,
                                     "apparentTemperature": 68.66, "dewPoint": 60.01, "humidity": 0.74,
                                     "pressure": 1019.4, "windSpeed": 0.76, "windGust": 1.73, "windBearing": 269,
                                     "cloudCover": 0.61, "uvIndex": 1, "visibility": 10, "ozone": 337.27}, "offset": -5}
